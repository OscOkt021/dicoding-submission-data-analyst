...
items_orders_products_payments_df = pd.read_csv('../data/data_ready/items_orders_products_data.csv')
state_mark_customer_count_df = pd.read_csv('../data/data_ready/state_mark_customer_count_data.csv')
order_city_count_df = pd.read_csv('../data/data_ready/order_city_count_data.csv')
...
with col1:
    ...
    ax = sns.barplot(x='product_category_name_english', y='product_id', data=products_count_df.head(10), palette=colors, legend=False, hue='product_category_name_english')
...
with col2:
    ...
    plt.figure(figsize=(10, 6))
    ax = sns.barplot(x='product_category_name_english', y='product_id', data=products_count_df.tail(10), palette=colors, legend=False, hue='product_category_name_english')
...
gdf = gpd.GeoDataFrame(state_mark_customer_count_df, geometry=geometry)
...
plt.figure(figsize=(10, 6))
ax = sns.barplot(x='customer_city', y='order_id', data=order_city_count_df.head(10), palette=colors, legend=False, hue='customer_city')
